/*----------------------------------------------------------------------
    NHocr - Japanese OCR     nhocr  ver 0.20
...
/*--------------
  Copyright 2008-2010  Hideaki Goto
...
static char	programTitle[] = "NHocr - Japanese OCR  v0.20";
...
static void usage(){
	fprintf(stderr,"%s  Copyright (C) 2008-2010 Hideaki Goto \n",programTitle);
	...
	fputs("         -gramd    :  enable language post-processing (default: disabled) \n",stderr);
